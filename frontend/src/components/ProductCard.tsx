...
const getDefaultAttributes = (product: Product): Record<string, string> => {
    ...
    if (product.attributes) {
        // Debug: Log the actual attributes for this product
        console.log(`[DEBUG] ProductCard - ${product.name} attributes:`, 
        ...
        // Create a safe copy to avoid any potential mutations
...
export default function ProductCard({product, onAddToCart, onProductClick}: ProductCardProps) {
    ...
    const handleQuickShop = (e: React.MouseEvent) => {
        e.stopPropagation();
        if (product.inStock) {
            // Get default selected options for quick shop
            const selectedOptions = getDefaultAttributes(product);
